import { Image, RichText, Field, ImageField, withDatasourceCheck } from '@sitecore-jss/sitecore-jss-nextjs';
                    ...
                    <div className="text-left">
                        <div className="popup-gallery">
                            <div className="col-md-6 col-sm-12 col-xs-12">
                                <a className="image-popup-no-margins" href="@image1Source" title="Relax time">
                                  <Image field={fields?.Image1} editable={true} />                                                                        
                                </a>
                            </div>
                            <div className="col-md-6 col-sm-12 col-xs-12">
                                <a className="image-popup-no-margins" href="@image2Source" title="Free place on beach">
                                  <Image field={fields?.Image2} editable={true} /> 
                                </a>
                                <div className="space-bottom-large"> </div>
                                <a className="image-popup-no-margins" href="@image3Source" title="Relax">
